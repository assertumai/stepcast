 ...
 * работы»), обёртки раннера `stepcast:step` и компилятора виджетов демона.
 * Проверяет как настоящий `dist/src/**`, так и синтетическое дерево с
 * подложенным нарушением — иначе зелёный результат ничего не значил бы: он
 * мог быть зелёным и потому, что проверка ничего не находит никогда.
 *
