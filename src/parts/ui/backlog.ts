 ...
 * `PipelineView` (`src/parts/ui/pipelines.ts`): карточка неразбираемого пайплайна и
 ...
 * вовсе — ни один отказ `src/parts/pipeline/domain/backlog/parse.ts` не заполняет `hint`, а
