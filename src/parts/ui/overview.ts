...
import type { AwaitingDecision, StatusValue, UsageRecord } from '../pipeline/run/journal/schema.js';
...
export interface RunOverview {
   ...
   * ровно в том же виде, что `PipelineView.file` (`src/parts/ui/pipelines.ts`): по
