...
import { hasPredicateEvaluator, hasStepExecutor, type PredicateContribution, type StepKindContribution } from '../contract.js';
import { BUILTIN_OWNER } from '../../../kernel/kernel.js';
