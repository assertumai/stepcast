...
import { PERMISSIVE_MODES } from '../../backends/claude/adapter.js';
...
import { hasPredicateEvaluator, hasStepExecutor } from '../contract.js';
import { availableNames, nativePredicateNames, nativeStepKindNames, type Registry } from '../../../kernel/registry.js';
 ...
 * же потолки (`runJudgePass` в `src/parts/pipeline/run/runner.ts`). Работа из одних
...
function checkScriptPredicate(
  ...
  // `resolveScript`, которая их не производит вовсе (`src/parts/pipeline/document/steps.ts`
