...
import { readManifest, resolveRun } from '../run/journal/reader.js';
import { mergeLanes, type LaneMergeResult } from '../domain/lanes/merge.js';
 ...
 * здесь, обход дорожек — в `src/parts/pipeline/domain/lanes/merge.ts`.
 */
