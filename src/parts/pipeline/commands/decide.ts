...
import { findProjectRoot, shortRunId } from '../run/journal/paths.js';
import { isRunAlive, readManifest, readStatus, resolveRun } from '../run/journal/reader.js';
import { writeDecisionRecord } from '../run/journal/writer.js';
import { expandPipeline } from '../document/expand.js';
import type { PipelineCommandEnv } from '../contract.js';
import { pipelineStepAddresses, selectAwaiting, validateDecision } from '../run/decision.js';
 ...
 * общие с демоном и с движком (`parts/pipeline/run/decision.ts`), чтобы обе дороги к
