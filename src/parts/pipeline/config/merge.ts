import { parseDuration, parseMoney, parseTokens } from '../../../kernel/units.js';
...
const TOKEN_VALUED = new Set([
  ...
  // Предел на производную часть оглавления (каталоги практики спецификации)
  // и на тело одной единицы знания — независимые от предела памяти величины.
  'project.knowledge.spec_index_max_tokens',
  'project.knowledge.unit_max_tokens',
]);
