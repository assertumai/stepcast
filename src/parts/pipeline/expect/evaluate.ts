...
import { runProcess } from '../run/exec/process.js';
import type { RunJournal } from '../run/journal/writer.js';
import { describeScriptUnresolved } from '../document/expand.js';
import type { Predicate, ScriptUnresolved } from '../document/model.js';
import type { PredicateResult } from '../run/journal/schema.js';
import type { KnowledgeSource } from '../domain/knowledge/types.js';
import { hasPredicateEvaluator } from '../contract.js';
 ...
 * переиспользуемого шага (`src/parts/pipeline/document/steps.ts`). Дефект схемы —
